  ...
  return (
    <section className="live-demo section">
      <div className="container">
        ...
        >
          <p>
            This is a simulated demonstration of our autonomous red team platform. 
            In the real system, bots continuously scan registered targets and smart contracts 
            automatically process verified findings with instant cryptocurrency payouts.
          </p>
        </motion.div>
      </div>
    </section>
